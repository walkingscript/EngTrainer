...
class Vocabulary:
    """Stores words.
    Provides the set of methods for work with vocabulary."""
    ...
    def get_all_translations(self):
        """Returns all translations from vocabulary."""
        return reduce(lambda a, b: a + b, self.__data.values())

    def get_random_pair(self):
        """Returns random pair consist of source word and one of its
        translation."""
    ...
    def __load_data_from_text_file(self):
        ...
        english word - русский перевод 1, русский перевод 2, ...,
        русский перевод N"""
        with open(self.filename, encoding='utf-8') as file:
            for i, line in enumerate(file.readlines()):
                try:
                    ...
                    print(f'Error on loading line {i}.\n{e}')
